...
export const dict = {
  ...
  "prompt.toast.stopFailed.title": "Failed to stop",
  ...
  "session.files.copyPathDone": "Path copied",
  ...
  "settings.general.row.serverPassword.description": "Password for server authentication. Default: opencode",
  "settings.general.row.serverRestart.note": "Changes require app restart to take effect.",

  "settings.localServer.title": "Local server",
  "settings.localServer.description": "Listen address and Basic Auth for this machine opencode server (desktop sidecar or opencode web/serve). Takes effect after restart.",
  "settings.localServer.listen.title": "Listen mode",
  "settings.localServer.listen.description": "Local: 127.0.0.1 only. Global: 0.0.0.0 (LAN / external).",
  "settings.localServer.listen.local": "Local (this device only)",
  "settings.localServer.listen.global": "Global (0.0.0.0, default)",
  "settings.localServer.save": "Save",
  "settings.localServer.saveRestart": "Save & restart server",
  "settings.localServer.restart": "Restart server",
  "settings.localServer.restarting": "Restarting…",
  "settings.localServer.saved": "Local server settings saved",
  "settings.localServer.restartProcess": "Restart the opencode web/serve process for changes to take effect.",
  "settings.localServer.showPassword": "Show",
  "settings.localServer.hidePassword": "Hide",
  ...
  "project.close.working.one": "1 conversation is still running.",
  "project.close.working.many": "{{count}} conversations are still running.",
  "project.close.note": "Closing will interrupt them and release project resources.",
}
