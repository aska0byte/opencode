...
export const dict = {
  ...
  "session.files.copyPath": "复制文件地址",
  "session.files.copyPathDone": "已复制路径",
  "session.files.sendToChat": "发送到对话框",
  ...
  "settings.general.row.serverPort.title": "服务器端口",
  "settings.general.row.serverPort.description": "本地服务器端口号 (1-65535)，默认: 4096",
  "settings.general.row.serverUsername.title": "用户名",
  "settings.general.row.serverUsername.description": "服务器认证用户名，默认: opencode",
  "settings.general.row.serverPassword.title": "密码",
  "settings.general.row.serverPassword.description": "服务器认证密码，默认: opencode",
  "settings.general.row.serverRestart.note": "更改需要重启应用后才能生效。",

  "settings.localServer.title": "本机监听",
  "settings.localServer.description": "本机 opencode 服务的监听地址与 Basic Auth（桌面 sidecar 或 opencode web/serve）。保存后需重启进程生效。",
  "settings.localServer.listen.title": "监听范围",
  "settings.localServer.listen.description": "本地仅 127.0.0.1；全局 0.0.0.0（局域网/外部可连）。",
  "settings.localServer.listen.local": "监听本地（仅本机）",
  "settings.localServer.listen.global": "监听全局（0.0.0.0，默认）",
  "settings.localServer.save": "保存",
  "settings.localServer.saveRestart": "保存并重启服务器",
  "settings.localServer.restart": "重启服务器",
  "settings.localServer.restarting": "正在重启…",
  "settings.localServer.saved": "本机服务配置已保存",
  "settings.localServer.restartProcess": "请重启 opencode web/serve 进程后生效。",
  "settings.localServer.showPassword": "显示",
  "settings.localServer.hidePassword": "隐藏",
  ...
  "project.close.title": "关闭项目",
  "project.close.confirm": '关闭项目「{{name}}」？',
  "project.close.button": "关闭项目",
  "project.close.working.one": "仍有 1 个对话在运行。",
  "project.close.working.many": "仍有 {{count}} 个对话在运行。",
  "project.close.note": "关闭将中断这些对话并释放该项目占用的资源。",
  "common.open": "打开",
  ...
  "session.todo.clear": "清空待办",
  "session.todo.clear.failed": "清空待办失败",
