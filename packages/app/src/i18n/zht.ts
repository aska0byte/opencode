...
export const dict = {
  ...
  "session.files.sendToChat": "傳送到對話框",
  ...
  "session.files.copyPath": "複製檔案路徑",
  "session.files.copyPathDone": "已複製路徑",
  "session.todo.clear": "清空待辦",
  "session.todo.clear.failed": "清空待辦失敗",
  "settings.general.section.server": "伺服器",
  "settings.general.row.serverPort.title": "伺服器連接埠",
  "settings.general.row.serverPort.description": "本機伺服器連接埠 (1-65535)，預設: 4096",
  "settings.general.row.serverUsername.title": "使用者名稱",
  "settings.general.row.serverUsername.description": "伺服器認證使用者名稱，預設: opencode",
  "settings.general.row.serverPassword.title": "密碼",
  "settings.general.row.serverPassword.description": "伺服器認證密碼，預設: opencode",
  "settings.general.row.serverRestart.note": "變更需重新啟動應用程式後才會生效。",
  "settings.localServer.title": "本機監聽",
  "settings.localServer.description": "本機 opencode 服務的監聽位址與 Basic Auth（桌面 sidecar 或 opencode web/serve）。儲存後需重新啟動程序生效。",
  "settings.localServer.listen.title": "監聽範圍",
  "settings.localServer.listen.description": "本機僅 127.0.0.1；全域 0.0.0.0（區域網路/外部可連）。",
  "settings.localServer.listen.local": "監聽本機（僅本機）",
  "settings.localServer.listen.global": "監聽全域（0.0.0.0，預設）",
  "settings.localServer.save": "儲存",
  "settings.localServer.saveRestart": "儲存並重新啟動伺服器",
  "settings.localServer.restart": "重新啟動伺服器",
  "settings.localServer.restarting": "正在重新啟動…",
  "settings.localServer.saved": "本機服務設定已儲存",
  "settings.localServer.restartProcess": "請重新啟動 opencode web/serve 程序後生效。",
  "settings.localServer.showPassword": "顯示",
  "settings.localServer.hidePassword": "隱藏",
  "project.close.title": "關閉專案",
  "project.close.confirm": "關閉專案「{{name}}」？",
  "project.close.button": "關閉專案",
  "project.close.working.one": "仍有 1 個對話在執行。",
  "project.close.working.many": "仍有 {{count}} 個對話在執行。",
  "project.close.note": "關閉將中斷這些對話並釋放該專案佔用的資源。",
